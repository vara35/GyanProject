...
import { SelectFolderMainContainer } from './styledComponents'
const url =
...
const SelectFolder = () => (
   <SelectFolderMainContainer>
      ...
      <CommonContainer>
         <ImageBottomTextEle color='#171f46' fontSize='12px' width='396px'>
            {text1}
         </ImageBottomTextEle>
         <ImageBottomTextEle color='#7e858e' fontSize='12px' width='217px'>
            {text2}
         </ImageBottomTextEle>
      </CommonContainer>
